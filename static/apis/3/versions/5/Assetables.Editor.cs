...
/// </summary>
namespace Stellar.APIs.Assetables // THIS IS FOR THE EDITOR ONLY! FOR ACTUAL USAGE AND REFERENCE PLEASE SEE AssetablesStorage.cs
{
    ...
    internal class AssetManagementWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            // Info box
            EditorGUILayout.HelpBox("Query groups with @, follow with a space to search for specific assets in the group, use quotes around a query to allow for entires that use spaces. Seperate asset name identifiers with / to diverge into groups. Search Ex: \'MyAsset\', \'@MyGroup\', \'@MyGroup MyAsset\' \'@\"My Group\" MyAsset\', \'@\"My Group\" \"My Asset\"\'. Name Ex: \'MyAsset\', \'MyGroup/MyAsset\', \'MyGroup/MyEmbeddedGroup/MyAsset\'", MessageType.Info);
            ...
            // Save
            if (GUILayout.Button("Save Changes (use if failing to save)"))
            {
